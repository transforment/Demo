...
(26, '+ Thông báo của UBND huyện, thành phố.<br>\r\n+ Hoặc các giấy tờ có liên quan để chứng minh.', '01 bộ.'),
(27, '+ Quyết định của cơ quan nhà nước có thẩm quyền (bản sao).<br>\r\n+ Thông báo của cơ quan cấp trên hoặc các giấy tờ có liên quan để chứng minh.', '01 bộ.'),
