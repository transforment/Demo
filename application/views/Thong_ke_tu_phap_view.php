    ...
    <div class="col-xs-12 col-md-12 pad">
        ...
        <div class="demo" id="demo-one">
            ...
            <nav class="subnav tabs">
                <ul>
                    <li class="active"><a href="#panel-1">Theo ngày  </a></li>
...
if (isset($chonNgay)){
                    ...
                    for ( $i = 0; $i <count($data2);$i++){
                        ...
                        if(substr($data2[$i]->mshs, 7, 6) == $myDayString ){
                            echo '<tr>
            ...
            <div class="panel clearfix" id="panel-1">
                ...
                for ( $i = 0; $i <count($data2);$i++){
                    ...
                    if( substr($data2[$i]->mshs, 7, 6) == $currentDate ){
                ...
                <table class="table table-hover">
                    ...
                    for ( $i = 0; $i <count($data2);$i++){
                        ...
                        if(substr($data2[$i]->mshs, 7, 6) == $currentDate &&$data2[$i]->status==5 ){
                            echo '<tr>
                ...
                <fieldset>
                    ...
                    for ( $i = 0; $i <count($data2);$i++) {
                        for ($j = 0; $j < count($daysOfTheCurrentWeek); $j++) {
                            ...
                            if ($data2[$i]->status == 5 && substr($data2[$i]->mshs, 7, 6) == $daysOfTheCurrentWeek[$j]) {
            ...
            <div class="panel" id="panel-3">
                ...
                for ( $i = 0; $i <count($data2);$i++){
                    ...
                    if($data2[$i]->status==5 && substr($data2[$i]->mshs, 9, 4) == $currentMonth ){
            ...
            <div class="panel" id="panel-4">
                ...
                for ( $i = 0; $i <count($data2);$i++){
                    ...
                    if($data2[$i]->status == 5 && substr($data2[$i]->mshs, 11, 2) == $currentYear ){
