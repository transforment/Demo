<?php
class Co_quan extends CI_Model {
	public $id;
	public $noi_dung;
...
if($noi_dung=='')return ;
    	$array=array(
			...
			$this->db->insert('co_quan',$array);
			
			$this->db->select_max('id');
			$query = $this->db->get('co_quan')->result_array();
...
if($noi_dung=='')return ;
			$this->db->where('noi_dung', $noi_dung);
   			$node_map = $this->db->get('co_quan')->row();
