...
if($noi_dung=='')return ;
    	$array=array(
			...
			$this->db->insert('can_cu',$array);
			
			$this->db->select_max('id');
			$query = $this->db->get('can_cu')->result_array();
...
if($noi_dung=='')return ;
			$this->db->where('noi_dung', $noi_dung);
   			$node_map = $this->db->get('can_cu')->row();
