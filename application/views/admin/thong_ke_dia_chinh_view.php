                ...
                <?}else {?>
                    ...
                    <table class="table table-hover">
                      ...
                      <td>' . $k . '</td>
                            ...
                            if($quarter == 1) {
                                for ($i = 0; $i < count($data2); $i++) {
                                    if ( (substr($data2[$i]->mshs, 9, 2) == "01" ||substr($data2[$i]->mshs, 9, 2) == "02"||substr($data2[$i]->mshs, 9, 2) == "03" )&&substr($data2[$i]->mshs, 11, 2)==$namInQuarter &&substr($data2[$i]->mshs, 16, 2)==$luachonInQuater && $data2[$i]->status == 5&&substr($data2[$i]->mshs, 14, 2)=="DD") {
                      ...
                      <td>' . $k . '</td>
                            ...
                            if($quarter == 2) {
                                for ($i = 0; $i < count($data2); $i++) {
                                    if ( (substr($data2[$i]->mshs, 9, 2) == "04" ||substr($data2[$i]->mshs, 9, 2) == "05"||substr($data2[$i]->mshs, 9, 2) == "06" )&&substr($data2[$i]->mshs, 11, 2)==$namInQuarter &&substr($data2[$i]->mshs, 16, 2)==$luachonInQuater && $data2[$i]->status == 5&&substr($data2[$i]->mshs, 14, 2)=="DD") {
                      ...
                      <td>' . $k . '</td>
                            ...
                            if($quarter == 3) {
                                for ($i = 0; $i < count($data2); $i++) {
                                    if ( (substr($data2[$i]->mshs, 9, 2) == "07" ||substr($data2[$i]->mshs, 9, 2) == "08"||substr($data2[$i]->mshs, 9, 2) == "09" )&&substr($data2[$i]->mshs, 11, 2)==$namInQuarter &&substr($data2[$i]->mshs, 16, 2)==$luachonInQuater && $data2[$i]->status == 5&&substr($data2[$i]->mshs, 14, 2)=="DD") {
                                        echo '<tr>
                      ...
                      <td>' . $k . '</td>
                            ...
                            if($quarter == 4) {
                                for ($i = 0; $i < count($data2); $i++) {
                                    if ( (substr($data2[$i]->mshs, 9, 2) == "10" ||substr($data2[$i]->mshs, 9, 2) == "11"||substr($data2[$i]->mshs, 9, 2) == "12" )&&substr($data2[$i]->mshs, 11, 2)==$namInQuarter &&substr($data2[$i]->mshs, 16, 2)==$luachonInQuater && $data2[$i]->status == 5&&substr($data2[$i]->mshs, 14, 2)=="DD") {
