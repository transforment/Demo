<div class="col-lg-12">
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-3 col-lg-3 " align="center" > <img alt="User Pic" src="<?php echo base_url('img/icon-profile.png');?>" class="img-circle img-responsive"> </div>
            ...
            <div class=" col-md-9 col-lg-9 ">
                ...
                <!--
                                        <div class="panel-footer">
                                            <a data-original-title="For later use" data-toggle="tooltip" type="button" class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-envelope"></i></a>
                                        <span class="pull-right">
                For Later If needed !
                                            <a data-trigger="hover" data-content="Hypercholesterolemia..." data-original-title="For later use" data-target="#" data-toggle="tooltip" type="button" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-edit"></i></a>
                                             <a data-original-title="For later use" data-toggle="tooltip" data-target="#"  type="button" class="btn btn-sm btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
                                        </span>
                                        </div>
                -->
